<template>
  ...
  <main class=" pb-16 lg:pt-16  lg:pb-24 bg-blue-100 dark:bg-blue-100 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl">
      <article
        ...
        <header class="mb-4 lg:mb-6 not-format">
          ...
          <span class=" flex justify-center text-xl  mb-4"> I enjoy weaving my words through the realms of fantasy,
    ...
    <div class="container mx-auto shadow-md">
      ...
      <h1 class=" flex justify-center text-2xl font-bold  ">Article Content :</h1>
      ...
      <table class="min-w-full table-auto border-collapse border border-gray-300">
        ...
        <tbody>
          <tr v-for="(article, index) in articles" :key="article.id" class="hover:bg-gray-50">
            ...
            <td class="border px-4 py-2">{{ article.Genre }}</td>
...
<script setup>
const articles = ref([
  { id: 1, title: 'Server-Nuxt', written: '2024-11-08', Genre: 'Technology' },
