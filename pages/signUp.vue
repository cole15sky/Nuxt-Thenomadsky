    ...
    <div class="min-h-screen bg-gray-100 flex items-center justify-center">
      <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form @submit.prevent="handleSignUp" class="mt-6 space-y-4">
          ...
          <button
            type="submit"
            class="w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-300"
          >
            Sign Up
          </button>
        </form>
        <p class="text-sm text-gray-600 mt-4 text-center">
          ...
          <NuxtLink  class="text-blue-500 hover:underline" to="/signin">Log In </NuxtLink>
        </p>
      </div>
    </div>
  </template>
...
const signIn = () => {
  ...
  const handleSignUp = () => {
    console.log('Sign Up Details:', form);
