      ...
      <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
          <a class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse cursor-pointer">
            <img src="/Assets/logo_sky.png" class="h-8" alt="site logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
              Tech-NomadSky</span>
          </a>

          <!-- Add space between the SVG icons -->
          <div class="flex space-x-6">
            <svg width="40px" height="40px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            </svg>

            <!-- Instagram -->
            <svg width="40px" height="40px" viewBox="0 -4 48 48" xmlns="http://www.w3.org/2000/svg" fill="#00AAEC">
              <svg width="40px" height="40px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Tweeter -->
            <svg width="40px" height="40px" viewBox="0 -4 48 48" xmlns="http://www.w3.org/2000/svg" fill="#00AAEC">
              <svg width="40px" height="40px" viewBox="0 -4 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
            ...
            <li>
              <NuxtLink class="hover:underline me-4 md:me-6" to="/about">About</NuxtLink>
            </li>
            <li>
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2024 <a class="hover:underline">ThenomadSky™</a>. All Rights Reserved.
        </span>
      </div>
    </footer>
  </div>
